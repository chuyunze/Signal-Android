...
val canonicalVersionName = "8.25.1"
...
android {
  ...
  defaultConfig {
    ...
    buildConfigField("String", "SIGNAL_URL", "\"https://chat.i201314.cn\"")
    buildConfigField("String", "STORAGE_URL", "\"https://chat.i201314.cn\"")
    buildConfigField("String", "SIGNAL_CDN_URL", "\"https://cdn.i201314.cn\"")
    buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://cdn.i201314.cn\"")
    buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn.i201314.cn\"")
    buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://chat.i201314.cn\"")
    buildConfigField("String", "SIGNAL_SERVICE_STATUS_URL", "\"chat.i201314.cn\"")
    buildConfigField("String", "SIGNAL_SVR2_URL", "\"https://chat.i201314.cn\"")
    buildConfigField("String", "SIGNAL_SFU_URL", "\"https://chat.i201314.cn\"")
    buildConfigField("String", "SIGNAL_STAGING_SFU_URL", "\"https://chat.i201314.cn\"")
    ...
    buildConfigField("String", "CONTENT_PROXY_HOST", "\"chat.i201314.cn\"")
